...
# BROKER_PENDING_MIGRATION_2026_06_15: migrate this active Mac-local classifier
# to the Broker broker-backed `claude_call()` path after SDK credit cutover.
