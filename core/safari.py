...
For interactive mode where the user is actively driving Safari: the agent
reads what's on screen, clicks things, fills fields. NOT for headless
automation — use `core.browser` (Playwright WebKit) for that.
