...
def dispatched_sdk_agent(
    *,
    ...
    try:
        # BROKER_PENDING_MIGRATION_2026_06_15: migrate this active Mac-local
        # wrapper to the Broker broker-backed `claude_call()` path after SDK
        # credit cutover.
